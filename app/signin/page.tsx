    ...
    <main className="min-h-screen bg-gradient-to-b from-emerald-50 to-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to view or edit your RSVP.</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your ITS ID and last name to access your existing RSVP.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                ...
                disabled={loading}
              >
                {loading ? "Please wait..." : "Access My RSVP →"}
              </Button>
            </form>
